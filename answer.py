...
def game_title():
    ...
    title_bg = pygame.image.load('D:\桌面1\新建文件夹\答题游戏\img\main.jpg')
    title_image = titleFont.render(title_text, True, color_dict['green'])
    title_time = 0
    mouseCursor = pygame.image.load('D:\桌面1\新建文件夹\答题游戏\img\cursor.png').convert_alpha()  # 加载鼠标图片
...
def main():
    ...
    pygame.display.set_icon(pygame.image.load('D:\桌面1\新建文件夹\答题游戏\img\delbrucks-brain.ico'))
    pygame.display.set_caption('魅力中医--答题类游戏 Version 1.0.0')

    titleFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\YaHei.ttf', 150)
    aboutFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\YaHei.ttf', 20)
    globalFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\Hei.ttf', 36)
    questionFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\HuaKanSong.ttf', 24)
    answerFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\HuaKanSong.ttf', 22)
    helpFont = pygame.font.Font('D:\桌面1\新建文件夹\答题游戏/font\HuaKanSong.ttf', 24)
